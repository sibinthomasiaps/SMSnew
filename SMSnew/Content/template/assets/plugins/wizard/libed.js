...
var form = $(".validationle-wizard").show();

$(".validationle-wizard").steps({
    headerTag: "h6"
    , bodyTag: "section"
    ...
    , onFinished: function (onclick, currentIndex) {
        ...
        var id = $('#LibraryId').val();
         ...
         window.location = "/libarybookissue/LibraryBookEditingData?Librarian=" + Librarian + "&id=" + id + "&SBN=" + SBN + "&Catagory=" + Catagory + "&Title=" + Title + "&Edition=" + Edition + "&Publisher=" + Publisher + "&BookNo=" + BookNo + "&ShelfNo=" + ShelfNo + "&Condition=" + Condition + "&BookCost=" + BookCost + "&Author=" + Author + "&NoCopies=" + NoCopies + "&Language=" + Language + "&BookStatus=" + BookStatus;

       

       
    }
}), $(".validationle-wizard").validate({
